...
export default function Footer() {
  ...
  const footerLinks = {
    shop: [
      { name: 'Headphones', href: '/explore?category=headphones' },
      { name: 'Earphones', href: '/explore?category=earphones' },
      { name: 'Speakers', href: '/explore?category=speakers' },
      { name: 'Soundbars', href: '/explore?category=soundbars' },
      { name: 'TWS', href: '/explore?category=tws' },
    ],
    company: [
