...
import { Heart, ShoppingCart, Star, ChevronLeft, ChevronRight, Truck, Shield, RotateCcw } from 'lucide-react';
    ...
    return (
      <div className={`min-h-screen pt-24 flex items-center justify-center ${
        ...
        <div className="text-center">
          ...
          <Link href="/explore" className="text-[#632C38] hover:underline">
            Back to Explore
          </Link>
        </div>
      </div>
    ...
    <div className={`min-h-screen pt-20 ${theme === 'dark' ? 'bg-[#0A0A0A]' : 'bg-white'}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex items-center gap-2 mb-8">
          <Link href="/" className={theme === 'dark' ? 'text-gray-400' : 'text-gray-600'}>Home</Link>
          <span className={theme === 'dark' ? 'text-gray-600' : 'text-gray-400'}>/</span>
          <Link href="/explore" className={theme === 'dark' ? 'text-gray-400' : 'text-gray-600'}>Explore</Link>
          <span className={theme === 'dark' ? 'text-gray-600' : 'text-gray-400'}>/</span>
